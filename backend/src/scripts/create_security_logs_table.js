...
async function createSecurityLogsTable() {
  console.log('Iniciando creacion de tabla security_audit_logs...');
  let conn;
  try {
    ...
    console.log('Conexion establecida como root. Creando tabla...');
    ...
    console.log('  - Permisos otorgados con exito.');
