...
Start-Process powershell -ArgumentList "-NoExit -Command `"cd '$ROOT\backend'; pnpm run dev`""

Start-Sleep -Seconds 2

Write-Host "[2/2] Lanzando FRONTEND en localhost:3000..." -ForegroundColor Green
Start-Process powershell -ArgumentList "-NoExit -Command `"cd '$ROOT\frontend'; pnpm run dev`""
